...
function larissa_widgets_init() {
    register_sidebar(
        array(
            'name'          => __( 'Blog Sidebar', 'larissa' ),
            'id'            => 'sidebar-1',
            'description'   => __( 'Add widgets here to appear in your sidebar on blog posts and archive pages.', 'larissa' ),
...
function larissa_scripts() {
    // Bootstrap.
    wp_enqueue_style( 'bootstrap-style', get_theme_file_uri( '/assets/css/bootstrap.css' ), array(), '20230216' );
    wp_enqueue_script( 'bootstrap-script', get_theme_file_uri( '/assets/js/bootstrap.js' ), array(), '20230216', true );

    // Theme stylesheet.
    wp_enqueue_style( 'larissa-style', get_stylesheet_uri(), array(), '20230216' );

    // Other.
    wp_enqueue_script( 'larissa-skip-link-focus-fix', get_theme_file_uri( '/assets/js/skip-link-focus-fix.js' ), array(), '20230216', true );
