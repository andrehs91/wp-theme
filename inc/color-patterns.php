 ...
 */
function larissa_custom_colors_css() {
    $hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

    /**
     * Filters Larissa default saturation level.
     *
     * @since Larissa 1.0
     *
     * @param int $saturation Color saturation level.
     */
    $saturation         = absint( apply_filters( 'larissa_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.larissa-front-page) .entry-title,
...
.colors-custom .larissa-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.larissa-front-page .panel-content .recent-posts article,
...
.colors-custom.larissa-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
    ...
    /**
     * Filters Larissa custom colors CSS.
     *
     * @since Larissa 1.0
     *
     ...
     */
    return apply_filters( 'larissa_custom_colors_css', $css, $hue, $saturation );
}
